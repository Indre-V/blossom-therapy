...
| insights-list.html         | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/insights-htmlchecker.png)         |
| category-search.html       | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/category-search-htmlchecker.png)  |
| search-results.html        | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/search-results-htmlchecker.png)   |
| add-insight.html           | ✅    | The errors caused by SummerNote Widget. Removed Widget and tested, no errors were returned. | ![Result](/docs/testing-md/validations/add-insight-htmlchecker.png)      |
| pending-approval-list.html | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/pending-approval-htmlchecker.png) |
| profile.html               | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/profile-approval-htmlchecker.png) |
| user-insights.html         | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/user-insights-htmlchecker.png)    |
| user-drafts.html           | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/user-drafts-htmlchecker.png)      |
| user-favourites.html       | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/user-favourites-htmlchecker.png)  |
| profile-update.html        | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/profile-update-htmlchecker.png)   |
| change-password            | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/change-password-htmlchecker.png)  |
| profile-delete.html        | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/profile-delete-htmlchecker.png)   |
| insight-details.html       | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/insight-details-htmlchecker.png)  |
| messages.html              | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/messages-htmlchecker.png)         |
| dev-details.html           | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/about-htmlchecker.png)            |
| contact.html               | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/contact-htmlchecker.png)          |
| delete-moda.html           | ✅    |                                                                                             | ![Result](/docs/testing-md/validations/delete-modal-htmlchecker.png)     |
| insight-update.html        | ✅    | The errors caused by SummerNote Widget. Removed Widget and tested, no errors were returned. | ![Result](/docs/testing-md/validations/insight-update-htmlchecker.png)   |
| signup.html                | ✅    | Errors are are related to built in Django form template                                     | ![Result](/docs/testing-md/validations/sign-up-htmlchecker.png)          |
...
| ------------------------ | ---- | ----------------------------------------------------------------------------------------------------------------- |
| settings.py              | ✅    | ![Result](/docs/testing-md/validations/settings-py.png)     |
| urls.py (blossom_app)    | ✅    | ![Result](/docs/testing-md/validations/urls-py-main-app.png)  |
| views.py(blossom_app)    | ✅    | ![Result](/docs/testing-md/validations/views-py-main-app.png)  |
| admin.py(insights)       | ✅    | ![Result](/docs/testing-md/validations/admin-py-insights.png)   |
| apps.py(insights)        | ✅    | ![Result](/docs/testing-md/validations/apps-py-insights.png)    |
| forms.py(insights)       | ✅    | ![Result](/docs/testing-md/validations/forms-py-insights.png)   |
| models.py(insights)      | ✅    | ![Result](/docs/testing-md/validations/models-py-insights.png)   |
| urls.py(insights)        | ✅    | ![Result](/docs/testing-md/validations/urls-py-insights.png)     |
| views.py(insights)       | ✅    | ![Result](/docs/testing-md/validations/views-py-insights.png)   |
| test_forms.py(insights)  | ✅    | ![Result](/docs/testing-md/validations/test-forms-insights.png)  |
| test_views.py(insights)  | ✅    | ![Result](/docs/testing-md/validations/test-views-insights.png) |
| test_models.py(insights) | ✅    | ![Result](/docs/testing-md/validations/test-models-insights.png) |
| admin.py(about)          | ✅    | ![Result](/docs/testing-md/validations/admin-py-about.png)       |
| forms.py(about)          | ✅    | ![Result](/docs/testing-md/validations/forms-py-about.png)      |
| models.py(about)         | ✅    | ![Result](/docs/testing-md/validations/models-py-about.png)     |
| views.py(about)          | ✅    | ![Result](/docs/testing-md/validations/views-py-about.png)      |
| urls.py(about)           | ✅    | ![Result](/docs/testing-md/validations/urls-py-about.png)      |
| admin.py(user_profile)   | ✅    | ![Result](/docs/testing-md/validations/admin-py-profile.png)   |
| views.py(user_profile)   | ✅    | ![Result](/docs/testing-md/validations/views-py-profile.png)    |
| models.py(user_profile)  | ✅    | ![Result](/docs/testing-md/validations/models-py-profile.png)    |
| forms.py(user_profile)   | ✅    | ![Result](/docs/testing-md/validations/forms-py-profile.png)    |
| urls.py(user_profile)    | ✅    | ![Result](/docs/testing-md/validations/urls-py-profile.png)      |
| apps.py(user_profile)    | ✅    | ![Result](/docs/testing-md/validations/apps-py-profile.png)    |
| signals.py(user_profile) | ✅    | ![Result](/docs/testing-md/validations/signals-py-profile.png)  |
...
Python's `unitest` framework offers a robust and flexible testing solution. 
